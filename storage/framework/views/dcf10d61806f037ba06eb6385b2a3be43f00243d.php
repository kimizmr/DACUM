                            ...
                            <th scope="row">
                                <div class="media align-items-center">
                                    ...
                                    <div class="media-body ml-4">
                                        <a href="<?php echo e(route('projects.show',$project)); ?>" class="name mb-0 h6 text-sm"><?php echo e($project->name); ?></a> <br> <span class="badge badge-xs badge-<?php echo e((\Auth::user()->checkProject($project->id) == 'Owner') ? 'success' : 'warning'); ?>" data-toggle="tooltip" data-placement="bottom" data-original-title="<?php echo e(__('You are ') .__(ucfirst($project->permission()))); ?>"><?php echo e(\Auth::user()->checkProject($project->id)); ?></span>
                                    </div>
                                </div>
                            </th>
                            <td>
...
<?php /**PATH C:\laragon\www\DACUM\resources\views/projects/list.blade.php ENDPATH**/ ?>