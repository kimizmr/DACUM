                            ...
                            <div data-v-f2a183a6="" class="d-header" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                <div data-v-f2a183a6="" class="d-header-inner">
                                    <div data-v-f2a183a6="" class="d-header-50">
                                        ...
                                        <p data-v-f2a183a6=""><?php if(\Auth::user()->name): ?><?php echo e(\Auth::user()->name); ?><?php endif; ?></p>
                                        <p data-v-f2a183a6="">
                                            <?php if($left_address['address']): ?><?php echo e($left_address['address']); ?><?php endif; ?>
                                            <?php if($left_address['city']): ?> <br> <?php echo e($left_address['city']); ?>, <?php endif; ?> <?php if($left_address['state']): ?><?php echo e($left_address['state']); ?><?php endif; ?> <?php if($left_address['zipcode']): ?> - <?php echo e($left_address['zipcode']); ?><?php endif; ?>
                                            <?php if($left_address['country']): ?> <br><?php echo e($left_address['country']); ?><?php endif; ?>
                                        </p>
                                    </div>
                            ...
                            <div data-v-f2a183a6="" class="d-body">
                                <div data-v-f2a183a6="" class="d-bill-to"><strong data-v-f2a183a6=""><?php echo e(__('Bill To')); ?>:</strong>
                                    <p>
                                        ...
                                        <?php endif; ?><br>
                                        <?php if($right_address['address']): ?><?php echo e($right_address['address']); ?><?php endif; ?>
                                        <?php if($right_address['city']): ?> <br> <?php echo e($right_address['city']); ?>, <?php endif; ?> <?php if($right_address['state']): ?><?php echo e($right_address['state']); ?><?php endif; ?> <?php if($right_address['zipcode']): ?> - <?php echo e($right_address['zipcode']); ?><?php endif; ?>
                                        <?php if($right_address['country']): ?> <br><?php echo e($right_address['country']); ?><?php endif; ?>
                                    </p>
                                    <div data-v-f2a183a6="" class="d-table">
                                        <div data-v-f2a183a6="" class="d-table">
                                            <div data-v-f2a183a6="" class="d-table-tr" style="background: <?php echo e($color); ?>;color:<?php echo e($font_color); ?>">
                                                ...
                                                <div class="d-table-th w-10"><?php echo e(__('Item')); ?></div>
                                                <div class="d-table-th w-5"><?php echo e(__('Price')); ?></div>
                                                <div class="d-table-th w-5 text-right"><?php echo e(__('Tax')); ?></div>
                                            </div>
                                                    ...
                                                    <?php $__currentLoopData = $invoice->items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <div class="d-table-tr" style="border-bottom:1px solid <?php echo e($border_color); ?>;">
                                                            ...
                                                            <div class="d-table-td w-10">
                                                                <pre data-v-f2a183a6=""><?php echo e($item->item); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5">
                                                                <pre data-v-f2a183a6=""><?php echo e(\App\Utility::projectCurrencyFormat($invoice->project_id,$item->price,true)); ?></pre>
                                                            </div>
                                                            <div class="d-table-td w-5 text-right">
                                                                <pre data-v-f2a183a6=""><?php echo e(\App\Utility::projectCurrencyFormat($invoice->project_id,$item->tax(),true)); ?></pre>
                                                            </div>
                                                        </div>
                                            ...
                                            <div data-v-f2a183a6="" class="d-table-footer">
                                                ...
                                                <div data-v-f2a183a6="" class="d-table-summary">
                                                    <div data-v-f2a183a6="" class="d-table-summary-item">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getSubTotal(),true)); ?></div>
                                                    </div>
                                                    <?php if($invoice->getTax()): ?>
                                                        <div data-v-f2a183a6="" class="d-table-summary-item">
                                                            <div data-v-f2a183a6="" class="d-table-label"><?php echo e($invoice->tax->name); ?> (<?php echo e($invoice->tax->rate); ?>%):</div>
                                                            <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getTax(),true)); ?></div>
                                                        </div>
                                                    <?php endif; ?>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($border_color); ?>; border-bottom: 1px solid <?php echo e($border_color); ?>;">
                                                        ...
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::projectCurrencyFormat($invoice->project_id,($invoice->getSubTotal()+$invoice->getTax()),true)); ?></div>
                                                    </div>
                                                    <div data-v-f2a183a6="" class="d-table-summary-item" style="border-top: 1px solid <?php echo e($border_color); ?>; border-bottom: 1px solid <?php echo e($border_color); ?>;">
                                                        <div data-v-f2a183a6="" class="d-table-label"><?php echo e(__('Due Amount')); ?>:</div>
                                                        <div data-v-f2a183a6="" class="d-table-value"><?php echo e(\App\Utility::projectCurrencyFormat($invoice->project_id,$invoice->getDue(),true)); ?></div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<?php /**PATH C:\laragon\www\DACUM\resources\views/invoices/templates/template1.blade.php ENDPATH**/ ?>