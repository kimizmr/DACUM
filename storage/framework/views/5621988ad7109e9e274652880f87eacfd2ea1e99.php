                            ...
                            <div class="card hover-shadow-lg">
                                            ...
                                            <div class="actions">
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu dropdown-menu-right">
                                                        ...
                                                        <a href="#" class="dropdown-item" data-url="<?php echo e(route('invoices.edit',[$invoice->id])); ?>" data-ajax-popup="true" data-size="md" data-title="<?php echo e(__('Edit ').\App\Utility::invoiceNumberFormat($invoice->invoice_id)); ?>">
                                                            <?php echo e(__('Edit')); ?>
                                ...
                                <div class="card-body pt-0">
                                    <div class="p-3 border border-dashed">
                                        <span class="text-sm text-muted font-weight-600"><?php echo e(\App\Utility::invoiceNumberFormat($invoice->invoice_id)); ?></span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DACUM\resources\views/invoices/index.blade.php ENDPATH**/ ?>