...
<div class="row">
    <div class="col-12 col-md-12">
        <div class="form-group">
            <?php echo e(Form::label('name', __('Duty name'),['class' => 'form-control-label'])); ?>
    ...
    <div class="col-12 col-md-12">
        <div class="form-group">
            <?php echo e(Form::label('image', __('Duty Image'),['class' => 'form-control-label'])); ?>
    ...
    <div class="col-12 col-md-4">
        <div class="form-group">
            <?php echo e(Form::label('estimated_hrs', __('Department ID'),['class' => 'form-control-label'])); ?>

            <?php echo e(Form::text('estimated_hrs', null, ['class' => 'form-control','min'=>'0','maxlength' => '8'])); ?>

        </div>
    </div>
    <div class="col-12 col-md-4">
        <div class="form-group">
            <?php echo e(Form::label('budget', __('Job title'),['class' => 'form-control-label'])); ?>

            <?php echo e(Form::text('budget', null, ['class' => 'form-control','step' =>'0.01'])); ?>
...
<?php /**PATH C:\laragon\www\DACUM\resources\views/projects/create.blade.php ENDPATH**/ ?>