                    ...
                    <div data-href="#tabs-3" class="list-group-item">
                        <div class="media">
                            ...
                            <div class="media-body ml-3">
                                ...
                                <p class="mb-0 text-sm"><?php echo e(__('Details about your pusher setting information for chat')); ?></p>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DACUM\resources\views/users/setting.blade.php ENDPATH**/ ?>