                    ...
                    <div class="card-body">
                        <?php $__currentLoopData = $home_data['project_status']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $status => $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="row align-items-center mb-4">
                                <div class="col-auto">
                                    <div class="progress-circle progress-sm" data-progress="<?php echo e($val['percentage']); ?>" data-color="<?php echo e(\App\Project::$status_color[$status]); ?>"></div>
                                </div>
                                <div class="col">
                                    <span class="d-block h6 mb-0"><?php echo e(__(\App\Project::$status[$status])); ?></span>
                                </div>
                            </div>
                        ...
                        <div class="d-flex my-1 text-center">
                            ...
                            <span class="badge badge-dot badge-lg h6">
                                <i class="bg-<?php echo e(\App\Project::$status_color[$status]); ?>"></i><?php echo e($val['total']); ?>
                                            ...
                                            <div class="d-flex align-items-center justify-content-between">
                                                ...
                                                <div class="flex-fill pl-3 text-limit">
                                                    ...
                                                    <div class="d-flex justify-content-between text-xs text-muted text-right mt-1">
                                                        <div>
                                                            <span class="font-weight-bold text-<?php echo e(\App\Project::$status_color[$due_project->status]); ?>"><?php echo e(\App\Project::$status[$due_project->status]); ?></span>
                                                        </div>
                                                        <div>
                            ...
                            <?php $__currentLoopData = $home_data['due_tasks']; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $due_task): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr>
                                    ...
                                    <span class="badge badge-dot mr-4">
                                        <i class="bg-<?php echo e(\App\ProjectTask::$priority_color[$due_task->priority]); ?>"></i>
                                        <span class="status"><?php echo e(\App\ProjectTask::$priority[$due_task->priority]); ?></span>
                                    </span>
                                    </td>
                                    <td>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DACUM\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>