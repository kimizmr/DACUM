                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                ...
                                <span class="h4 font-weight-bold mb-0 "><?php echo e(\App\Utility::projectCurrencyFormat($project->id,$project_data['expense']['total'])); ?></span>
                            </div>
                            <div class="col-auto">
                        ...
                        <div class="row">
                            <div class="col-12">
                                <span class="text-sm text-muted"><?php echo e(__('Total Budget : '.\App\Utility::projectCurrencyFormat($project->id,$project_data['expense']['allocated']))); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                                    ...
                                    <div class="media align-items-center">
                                        <div class="media-body">
                                            <h6 class="text-sm d-block text-limit mb-0"><?php echo e($milestone->title); ?>
                                                ...
                                                <span class="badge badge-pill badge-<?php echo e(\App\Project::$status_color[$milestone->status]); ?>"><?php echo e(__(\App\Project::$status[$milestone->status])); ?></span>
                                            </h6>
                                    ...
                                    <?php $__currentLoopData = $project->activities; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $activity): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <div class="timeline-block">
                                            ...
                                            <div class="timeline-content">
                                                <span class="text-dark text-sm"><?php echo e($activity->log_type); ?></span>
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DACUM\resources\views/projects/show.blade.php ENDPATH**/ ?>