                    ...
                    <div class="form-group mb-0">
                        <div class="d-flex align-items-center justify-content-between">
                            ...
                            <?php if(Route::has('password.request')): ?>
                                <div class="mb-2">
                                    <a href="<?php echo e(route('password.request')); ?>" class="small text-muted text-underline--dashed border-primary"><?php echo e(__('Lost password?')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="input-group input-group-merge">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="card-footer px-md-5"><small><?php echo e(__('Not registered?')); ?></small>
                <a href="<?php echo e(route('register')); ?>" class="small font-weight-bold"><?php echo e(__('Create account')); ?></a>
            </div>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('layouts.auth', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\main_file\resources\views/auth/login.blade.php ENDPATH**/ ?>