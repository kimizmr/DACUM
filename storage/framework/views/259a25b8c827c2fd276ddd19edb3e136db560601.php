...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('assets/css/site-blue-light.css')); ?>">
    ...
    <section class="slice slice-lg bg-gradient-dark" data-offset-top="#header-main" style="padding-top: 147.188px;">
        ...
        <div class="bg-absolute-cover bg-size--contain d-flex align-items-center">
            <figure class="w-100 d-none d-lg-block">
                <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="1016px" height="732px" viewBox="0 0 1016 732" version="1.1" class="injected-svg svg-inject">
            ...
            <div class="row row-grid justify-content-around align-items-center">
                <div class="col-lg-8">
                    <div class="pt-6 text-center">
                        <h1 class="text-white mb-3">DACUM</h1>
                    </div>
                    <div class="mt-5 mb--100 d-none d-lg-block">
                        <div class="frame-laptop swiper-js-container">
                            <img alt="Image placeholder" src="<?php echo e(asset('assets/img/macbook.svg')); ?>" class="img-fluid">
                                ...
                                <div class="swiper-container h-100 swiper-container-initialized swiper-container-horizontal" data-swiper-items="1" data-swiper-space-between="0" style="cursor: grab;">
                                    <div class="swiper-wrapper" style="transform: translate3d(0px, 0px, 0px);">
                                        <div class="swiper-slide swiper-slide-active">
                                            <div class="bg-img-holder top-0 right-0 col-12" data-bg-size="cover" style="background-image: url('<?php echo e(asset('assets/img/laptop-banner.png')); ?>'); background-position: initial; background-size: cover; opacity: 1; height: 100%;">
                                                <img alt="Image placeholder" src="<?php echo e(asset('assets/img/laptop-banner.png')); ?>">
                                            </div>
                                        </div>
                                    </div>
                ...
                <a href="#reviews" data-scroll-to>
                    <div class="blurable-item client-group row justify-content-center">
                        <div class="client col-lg-2 col-md-3 col-4 py-3">
                            <img alt="Image placeholder" src="<?php echo e(asset('assets/img/amazon-gray.svg')); ?>">
                        </div>
                        <div class="client col-lg-2 col-md-3 col-4 py-3">
                            <img alt="Image placeholder" src="<?php echo e(asset('assets/img/spotify-gray.svg')); ?>">
                        </div>
                        <div class="client col-lg-2 col-md-3 col-4 py-3">
                            <img alt="Image placeholder" src="<?php echo e(asset('assets/img/airbnb-gray.svg')); ?>">
                        </div>
                        <div class="client col-lg-2 col-md-3 col-4 py-3">
                            <img alt="Image placeholder" src="<?php echo e(asset('assets/img/paypal-gray.svg')); ?>">
                        </div>
                        <div class="client col-lg-2 col-md-3 col-4 py-3">
                            <img alt="Image placeholder" src="<?php echo e(asset('assets/img/slack-gray.svg')); ?>">
                        </div>
                        <div class="client col-lg-2 col-md-3 col-4 py-3">
                            <img alt="Image placeholder" src="<?php echo e(asset('assets/img/airbnb-gray.svg')); ?>">
                        </div>
    ...
    <section class="slice slice-lg" id="features">
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                ...
                <div class="col-lg-6">
                    <img alt="Image placeholder" src="<?php echo e(asset('assets/img/product-1.png')); ?>" class="img-fluid img-center">
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                ...
                <div class="col-lg-6 order-lg-1">
                    <img alt="Image placeholder" src="<?php echo e(asset('assets/img/product-2.png')); ?>" class="img-fluid img-center">
                </div>
            </div>
        </div>
    </section>
    <section class="slice slice-lg">
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                ...
                <div class="col-lg-6">
                    <img alt="Image placeholder" src="<?php echo e(asset('assets/img/product-3.png')); ?>" class="img-fluid img-center">
                </div>
            </div>
        </div>
    </section>
    <section class="slice slice-lg">
        <div class="container">
            <div class="row row-grid justify-content-around align-items-center">
                ...
                <div class="col-lg-6 order-lg-1">
                    <img alt="Image placeholder" src="<?php echo e(asset('assets/img/product-4.png')); ?>" class="img-fluid img-center">
                </div>
            </div>
        </div>
    </section>
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder" src="<?php echo e(asset('assets/img/team-1-800x800.jpg')); ?>" class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
                                    ...
                                    <div class="swiper-slide p-4 swiper-slide-next" style="width: 333.5px;">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder" src="<?php echo e(asset('assets/img/team-2-800x800.jpg')); ?>" class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
                                    ...
                                    <div class="swiper-slide p-4" style="width: 333.5px;">
                                        ...
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="d-flex align-items-center">
                                                    <div>
                                                        <img alt="Image placeholder" src="<?php echo e(asset('assets/img/team-3-800x800.jpg')); ?>" class="avatar  rounded-circle">
                                                    </div>
                                                    <div class="pl-3">
            ...
            <div class="row pt-md">
                <div class="col-lg-4 mb-5 mb-lg-0">
                    <a href="<?php echo e(url('home')); ?>">
                        <img src="<?php echo e(asset(Storage::url('logo/logo.png'))); ?>" id="navbar-logo" style="height: 25px;">
                    </a>
...
<?php /**PATH C:\laragon\www\DACUM\resources\views/landing.blade.php ENDPATH**/ ?>