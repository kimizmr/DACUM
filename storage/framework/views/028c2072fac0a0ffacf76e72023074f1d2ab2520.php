                ...
                <div class="card-body">
                    <?php if(!empty($user->skills)): ?>
                        <?php $__currentLoopData = explode(',',$user->skills); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $skill): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <span class="badge badge-pill badge-primary"><?php echo e($skill); ?></span>
                                            ...
                                            <div class="px-3 py-3">
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-auto actions">
                                                        <a href="<?php echo e(asset(Storage::url('tasks/'.$task_file->file))); ?>" download class="action-item" role="button">
...
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\DACUM\resources\views/users/info.blade.php ENDPATH**/ ?>