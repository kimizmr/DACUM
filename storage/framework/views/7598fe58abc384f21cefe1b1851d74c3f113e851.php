...
<div class="nav-application clearfix">
    ...
    <?php if(Auth::user()->type != 'admin'): ?>
        ...
        <a href="<?php echo e(url('messages')); ?>" class="btn btn-square text-sm <?php echo e(request()->is('messages') ? 'active' : ''); ?>">
...
<?php /**PATH C:\laragon\www\DACUM\resources\views/partials/admin/sidebar.blade.php ENDPATH**/ ?>